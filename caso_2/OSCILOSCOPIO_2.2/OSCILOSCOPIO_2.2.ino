...
void setup() {
  ...
  // Configurar SPI para mayor velocidad
  SPI.setClockDivider(SPI_CLOCK_DIV2); // 8MHz en lugar de 4MHz por defecto
}
...
void loop() {
  ...
  // Reducir delay para mayor frecuencia de muestreo
  delay(25);  // 200Hz en lugar de 40Hz
}